 ...
 */
@property (nonatomic, strong, readonly, nullable) NSString *productIdentifier;

/**
 The transaction identifier of the item that was purchased. This value corresponds to the transaction’s transactionIdentifier property.
 */
@property (nonatomic, strong, readonly, nullable) NSString *transactionIdentifier;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSString *originalTransactionIdentifier;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSDate *purchaseDate;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSDate *originalPurchaseDate;
 ...
 */
- (nullable id)initWithASN1Data:(nullable NSData*)asn1Data;
 ...
 */
- (BOOL)isActiveAutoRenewableSubscriptionForDate:(nullable NSDate*)date;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSString *bundleIdentifier;

/** The bundle identifier as data, as contained in the receipt. Used to verifiy the receipt's hash.
 @see verifyReceiptHash
 */
@property (nonatomic, strong, readonly, nullable) NSData *bundleIdentifierData;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSData *opaqueValue;

/** A SHA-1 hash, used to validate the receipt.
 */
@property (nonatomic, strong, readonly, nullable) NSData *receiptHash;

/** Array of in-app purchases contained in the receipt.
 @see RMAppReceiptIAP
 */
@property (nonatomic, strong, readonly, nullable) NSArray<RMAppReceiptIAP *> *inAppPurchases;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSString *originalAppVersion;
 ...
 */
- (BOOL)containsInAppPurchaseOfProductIdentifier:(nullable NSString*)productIdentifier;
...
/** Returns whether the receipt contains an active auto-renewable subscription for the given product identifier and for the given date.
 ...
 @warning If this method fails Apple recommends to refresh the receipt and try again once.
 */
- (BOOL)containsActiveAutoRenewableSubscriptionOfProductIdentifier:(nullable NSString *)productIdentifier forDate:(nullable NSDate *)date;
 ...
 */
+ (nullable RMAppReceipt*)bundleReceipt;
 ...
 */
+ (void)setAppleRootCertificateURL:(nullable NSURL*)url;
